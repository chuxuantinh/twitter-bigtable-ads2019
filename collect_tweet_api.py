...
def tw_get_tweets(api,  query_in, Qye_words, geo, location, num_tweets=200):
    ...
    csvWriter.writerow(["created", "text", "retwc", "hashtag", "followers", "friends", "geo"])
    counter = 0
    example_tweet = None
    word_list = []
    ...
    while True:
        try:
            ...
            csvWriter.writerow([created, str(text)])  # new
            counter = counter +1
...
def tw_search_json(query, cnt=200):
    authfile = 'auth.k'
...
if __name__ == '__main__':
    ...
    #print(tw_search_json('iphone', 200))