...
location_list = [['Ha Noi', 'Ho Chi Minh ', 'Can Tho', 'Viet Nam', 'viet nam'],['Thanh hoa']]
...
if __name__ == '__main__':
    ...
    for i in range(n_times):
        ...
        #fjob = 'gsutil cp ' + fname + ' gs://chutinh-bucket'
        #print('running : ', fjob)
        print('Running: gsutil ls -l gs://chutinh-bucket/tweet')
        os.system('gsutil ls -l gs://chutinh-bucket/tweet')
        print('Running: gsutil rm  -f  gs://chutinh-bucket/tweet/*')
        os.system("gsutil rm  -f  gs://chutinh-bucket/tweet/tweet_words.txt")
        print('Running: gsutil cp tweet_words.txt gs://chutinh-bucket/tweet')
        os.system("gsutil cp tweet_words.txt gs://chutinh-bucket/tweet")
        #os.system(fjob)
        #print(fname, ' is uploaded to gs://chutinh-bucket')
        print('Running: gsutil ls -l gs://chutinh-bucket/tweet')
        os.system('gsutil ls -l gs://chutinh-bucket/tweet')
    ...
    jar target/wordcount-mapreduce-1.0-jar-with-dependencies.jar \
     wordcount-hbase \
      ...
      \"tweet-count\"'
        ...
        keys, vals = get_top5_freq_words(project_id='assigntin2019', instance_id='ads2019cxt',
                                         table_name='tweet2020')
